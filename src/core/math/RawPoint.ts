...
export class RawPoint {
	...
	static invalid(): RawPoint {
		return new RawPoint(0, 0, 0, false);
	}
	static nullVector(): RawPoint {
		return new RawPoint(0, 0, 0, true);
	}
	static nanVector(): RawPoint {
		return new RawPoint(Number.NaN, Number.NaN, Number.NaN, true);
	}
